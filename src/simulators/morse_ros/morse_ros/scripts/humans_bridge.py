...
from human_msgs.msg import HumanMarkerStamped
from nav_msgs.msg import Odometry
import message_filters


class MorseHumans(object):
    ...
    def HumansCB(self,*msg):
        ...
        for human_id in range(1,self.num_hum+1):
            ...
            human_segment.pose.pose = msg[human_id-1].human.pose
            human_segment.twist.twist = msg[human_id-1].human.velocity
...
if __name__ == '__main__':
    nh = sys.argv[1]
    humans = MorseHumans(num_hum=int(nh))
    humans.HumansPub()
